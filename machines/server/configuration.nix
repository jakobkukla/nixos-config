{
  ...
  # FIXME: Currently this needs to be turned off for initrd ssh.
  ...
  boot = {
    ...
    initrd.network = {
      ...
      ssh = {
        ...
        authorizedKeys = ["ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHWojtiUPbNshRKobtKSdt2Cp0HdHPn4qqpSzALSZ1rv jakob.kukla@gmail.com"];
      };
    };
  };
}
